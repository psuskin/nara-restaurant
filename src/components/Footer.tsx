      ...
      <footer className="w-full bg-black border-t border-white/10 text-white z-1">
        <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="space-y-3 sm:space-y-4">
              <h3 className="text-white/90 text-xs sm:text-sm uppercase tracking-wider font-medium mb-3 sm:mb-4">
                {dict.hours || "Allgemeine Öffnungszeiten"}
              </h3>
              <div className="space-y-2 text-white/60">
                <div className="flex justify-between">
                  <p className="text-xs sm:text-sm">
                    {dict.monday || "Sonntag - Donnerstag"}
                  </p>
                  <p className="text-xs sm:text-sm">07:00 - 23:30</p>
                </div>
                <div className="flex justify-between">
                  <p className="text-xs sm:text-sm">
                    {dict.friday || "Freitag & Samstag"}
                  </p>
              ...
              <h3 className="text-white/90 text-xs sm:text-sm uppercase tracking-wider font-medium mb-3 sm:mb-4">
                {dict.hours || "Frühstück"}
              </h3>
              <div className="space-y-2 text-white/60">
                <div className="flex justify-between">
                  <p className="text-xs sm:text-sm">
                    {dict.monday || "Montag - Freitag"}
                  </p>
                  <p className="text-xs sm:text-sm">07:00 - 11:00</p>
                </div>
                <div className="flex justify-between">
                  <p className="text-xs sm:text-sm">
                    {dict.friday || "Freitag & Samstag"}
                  </p>
                  <p className="text-xs sm:text-sm">08:00 - 12:00</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              <h3 className="text-white/90 text-xs sm:text-sm uppercase tracking-wider font-medium mb-3 sm:mb-4">
                {dict.hours || "Mittagstisch Öffnungszeiten"}
              </h3>
              <div className="space-y-2 text-white/60">
                <div className="flex justify-between">
                  <p className="text-xs sm:text-sm">
                  ...
                  <p className="text-xs sm:text-sm">12:00 - 15:00</p>
                </div>
                <div className="h-0.5 w-full bg-white/10 my-2"></div>
              </div>

              <h3 className="text-white/90 text-xs sm:text-sm uppercase tracking-wider font-medium mb-3 sm:mb-4">
                {dict.hours || "Warme Küche"}
              </h3>
              <div className="space-y-2 text-white/60">
                <div className="flex justify-between">
                  <p className="text-xs sm:text-sm">
                    {dict.monday || "Sonntag, Dienstag Mittwoch & Donnerstag"}
                  </p>
                  <p className="text-xs sm:text-sm">18:00 - 22:00</p>
                </div>
                <div className="flex justify-between">
                  <p className="text-xs sm:text-sm">
                    {dict.monday || "Freitag & Samstag"}
                  </p>
                  <p className="text-xs sm:text-sm">18:00 - 23:00</p>
                </div>
                <div className="flex justify-between">
                  <p className="text-xs sm:text-sm">
                    {dict.monday || "Montag"}
                  </p>
                  <p className="text-xs sm:text-sm">Geschlossen</p>
                </div>
                <div className="h-0.5 w-full bg-white/10 my-2"></div>
              </div>
